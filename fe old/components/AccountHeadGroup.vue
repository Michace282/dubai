    ...
    <div class="account-head-group">
        ...
        <div class="bg-grey d-none d-lg-flex mt-45" v-if="user">
            ...
            <div v-if="user.profile && user.profile.address">
                ...
                <div class="value" v-if="user.profile && user.profile.city">
                    <span class="label">City: </span>{{ user.profile.city }}
                </div>
                <div class="value" v-if="user.profile && user.profile.country">
                    <span class="label">Country: </span>{{ user.profile.country }}
                </div>
            </div>
            <div>

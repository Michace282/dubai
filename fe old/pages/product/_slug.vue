<template>
    <div>
                    ...
                    <div class="container">
                        ...
                        <div class="d-flex justify-content-between w-100">
                            ...
                            <div class="right-block mt-30 d-none d-lg-block">
                                ...
                                <button class="btn btn-black" @click="handleWriteReview">
                                    Write a rewiew
                                </button>
                            </div>
                        </div>
        ...
        <div class="productMain" v-if="showModal">
...
<script>
    ...
    export default {
        name: 'product',
        components: {CommentGroup, RatingGroup, ProductCarousel, ProductItemsCarousel, CommentForm, Loader, AuthForm, RegForm},
        data() {
            return {
                countRatings: [],
                colorVal: 0,
